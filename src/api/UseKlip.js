...
export const mintCardWithURI = async (toAddress, tokenId, uri, setQrvalue, cb) => {
  const urijson =
  ...
  executeContract(NFT_CONTRACT_ADDRESS, urijson, "0", `[\"${toAddress}\",\"${tokenId}\",\"${uri}\"]`, setQrvalue, cb);
};
